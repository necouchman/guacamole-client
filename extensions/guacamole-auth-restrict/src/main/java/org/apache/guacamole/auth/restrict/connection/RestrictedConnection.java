...
public class RestrictedConnection extends DelegatingConnection implements Restrictable {
    ...
    /**
     * The string that contains the absolute date and time on which this
     * connection expires and the connection will no longer be available for
     * use.
     */
    public static final String RESTRICT_CONNECTION_EXPIRATION = "guac-restrict-expires";
    ...
    public static final List<String> RESTRICT_CONNECTION_ATTRIBUTES = Arrays.asList(
            ...
            RESTRICT_CONNECTION_EXPIRATION
    );
    ...
    public static final Form RESTRICT_CONNECTION_FORM = new Form("restrict-login-form",
            Arrays.asList(
                    ...
                    new DateTimeRestrictionField(RESTRICT_CONNECTION_EXPIRATION)
            )
    );
